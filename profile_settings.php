...
<head>
    ...
    <title>Profile Settings - SEDCO Staff Directory</title>
        ...
        <div class="w-64 bg-white shadow-lg h-screen fixed">
            ...
            <nav class="mt-4">
                ...
                <div class="px-4 py-2">
                    ...
                    <a href="profile_settings.php" class="block pl-4 py-1 text-sm text-blue-600">Profile Settings</a>
                    ...
                    <form method="POST" action="">
                        <div class="grid grid-cols-1 gap-6">
                            <div>
                                ...
                                <input type="text" name="username" value="admin" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="password" name="confirm_password" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            </div>
                        </div>
